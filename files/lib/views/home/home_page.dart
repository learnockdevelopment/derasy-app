          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Icon(icon, color: Colors.white, size: Responsive.sp(15)),
              ),
            ],
          ),
    ...
    return CustomScrollView(
      slivers: [
        ...
        SliverToBoxAdapter(
          child: Padding(
            padding: Responsive.symmetric(horizontal: 20),
            child: ShimmerCard(height: Responsive.h(200), borderRadius: Responsive.r(28)),
          ),
        ),
        SliverToBoxAdapter(child: SizedBox(height: Responsive.h(24))),
        // Stats Shimmer
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: Row(
              children: [
                Expanded(child: ShimmerCard(height: Responsive.h(140), borderRadius: Responsive.r(24))),
                SizedBox(width: Responsive.w(16)),
                Expanded(child: ShimmerCard(height: Responsive.h(140), borderRadius: Responsive.r(24))),
              ],
            ),
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Expanded(child: ShimmerCard(height: Responsive.h(160), borderRadius: Responsive.r(24))),
                    SizedBox(width: Responsive.w(16)),
                    Expanded(child: ShimmerCard(height: Responsive.h(160), borderRadius: Responsive.r(24))),
                  ],
                ),
        ...
        SliverToBoxAdapter(
          child: Padding(
            padding: Responsive.symmetric(horizontal: 20),
            child: ShimmerCard(height: Responsive.h(100), borderRadius: Responsive.r(24)),
          ),
        ),
      ],
    );
