    ...
    try {
      ...
      if (e.toString().contains('405') ||
        ...
        Get.snackbar(
          ...
          'Pickup permissions retrieval is not available for this school. You can still add new permissions.',
        ...
        Get.snackbar(
          'Error',
          'Failed to load pickup permissions: ${e.toString()}',
          snackPosition: SnackPosition.BOTTOM,
  ...
  Future<void> _addPermission() async {
    ...
    try {
      ...
      if (response.success) {
        ...
        Get.snackbar(
          'Success',
          'Pickup permission added successfully',
          snackPosition: SnackPosition.BOTTOM,
      ...
      Get.snackbar(
        'Error',
        'Failed to add pickup permission: ${e.toString()}',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: AppColors.error,
        colorText: Colors.white,
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(
          'Pickup Permissions - ${widget.student.fullName}',
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.h),
            Text(
              'Add pickup permissions for this student using the form above',
              style: AppFonts.bodyMedium.copyWith(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Note: Some schools may not support viewing existing pickup permissions, but you can still add new ones.',
