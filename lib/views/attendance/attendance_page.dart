  ...
  Future<void> _loadAttendance() async {
    ...
    try {
      ...
      if (e.toString().contains('Unauthorized') ||
        ...
        Get.snackbar(
          'Access Denied',
          'You do not have permission to view attendance records for this school.',
          snackPosition: SnackPosition.BOTTOM,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8.h),
          Text(
            'Choose a school to view attendance records',
            style: AppFonts.bodyMedium.copyWith(
              color: AppColors.textSecondary,
            ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'If you believe you should have access to attendance records, please contact your administrator.',
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  record.childName ?? 'Unknown Student',
                  style: AppFonts.h5.copyWith(
                    color: AppColors.textPrimary,
                  ),
                ),
