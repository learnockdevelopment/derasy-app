      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              _buildModernInfoCard('school_name'.tr, school.name, Icons.school_rounded, const Color(0xFF3B82F6)),
              _buildModernInfoCard('school_type'.tr, school.type ?? 'N/A', Icons.category_rounded, const Color(0xFF10B981)),
              _buildModernInfoCard('education_system'.tr, school.educationSystem ?? 'N/A', Icons.auto_stories_rounded, const Color(0xFFF59E0B)),
              _buildModernInfoCard('school_location'.tr, '${school.location?.city ?? 'N/A'}, ${school.location?.governorate ?? 'N/A'}', Icons.location_on_rounded, const Color(0xFF8B5CF6)),
              _buildModernInfoCard('governorate'.tr, school.location?.governorate ?? 'N/A', Icons.map_rounded, const Color(0xFFEF4444)),
              _buildModernInfoCard('city'.tr, school.location?.city ?? 'N/A', Icons.location_city_rounded, const Color(0xFF06B6D4)),
            ],
          ),
        ],
      ), 
